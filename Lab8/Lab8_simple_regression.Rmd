...
**The dataset 'hfi' has 1458 observations. Each observation represents the annual data included in the Human Freedom Index reports from 2008-2016. There are 123 different variables in this dataset that describe the idea of "freedom", such as political, religious, economical or personal freedom.**
...
*Question when reviewing the lab: how can you determine what value should be the x, and what should be the y?*
...
```{r exercise-4-response, echo=TRUE}
  ...
  plot_ss(hfi$pf_expression_control, hfi$pf_score, showSquares=FALSE, leastSquares=FALSE)

```

**The lowest sum of squares produced in this exercise was 5359.325.**
...
ggplot(hfi, aes(x=hf_score, y=pf_expression_control)) +
  geom_point()
...
**The slope provided in the R output is from the lm() function is 0.349862. Using the values provided in the output from lm we can produce the following equation of the regression line:**
