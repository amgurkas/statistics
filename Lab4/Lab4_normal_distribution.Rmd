...
# ggplot(data = mcd_dq_plot, aes(x = calories, fill=restaurant)) +
...
# comparing the simulated data with the mcd_dq_plot data 
ggplot(dairy_queen, aes(sample=cal_fat, col=restaurant)) +
  geom_qq() +
  geom_qq_line()
```

**All the points do not fall on the line. This plot seems to have a more normal distribution than the real data, which follows the line less as there are outliers within the McDonalds and Dairy Queen datasets.**
