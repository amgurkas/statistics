...
##### Note on Lab 1 9/4/2024
I provided headers at the beginning of each response in case you may need to search for them (all are formatted as Exercise [N] Response).
...
The number of girls baptized over the years increased over time, with a decrease in 1704.
...
```
<br>
The graph above is a line graph depicting the proportion of boys born over time from years 1629-1710, using data from the dataset 'arbuthnot'. There is relatively a higher ratio of boys born than girls born over time. However, it is decreasing over time.  
...
# there were originally 82 rows and 3 columns in the arbuthnot dataset 
# but we added three columns ('total', 'boy_to_girl_ratio', 'boy_ratio')
...
The year ranges for the two datasets are different. The dataset 'arbuthnot' includes years 1629-1710. The arbuthnot dataset has 19 more rows of data than the 'present' dataset. The original column names in the datasets are both 'year', 'boys' and 'girls'. The column names that have been added to the arbuthnot dataset in this Rmd are 'total', 'boy_to_girl_ratio', and 'boy_ratio'. As 19 rows of data is not a substantial amount of data, the datasets are a similar magnitude. 
...
The graph above is a line graph depicting the proportion of boys born over time from years 1940-2002, using data from the dataset 'present'. There is relatively a higher ratio of boys born than girls born over time. However, it is decreasing over time, similar to the dataset 'arbuthnot'. 
...
##### Exercise 7 Response
To find the maximum number of total births in the US we would do the following:
...
**The year with the most births in the US from the 'present' dataset is 1961, with 4268326 births.**

If we wanted to only conduct this exercise for the 'arbuthnot' dataset to find the maximum number of baptisms we would do the following:
...
- How did you create this Rmd template? Did you create a CSS Script for the color palette and formatting? I would like to create something similar for a work project. 
<br>
- Did I answer the last question correctly? I wasn't sure if you wanted me to only provide the year or the entire row of data. 
